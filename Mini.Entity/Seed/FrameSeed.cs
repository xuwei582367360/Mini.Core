...
namespace Mini.Model.Seed
{
    public class FrameSeed
    {
        ...
        {
            Create_Controller_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Mini.CoreApi.Controllers", "Mini.CoreApi.Controllers", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Model_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"D:\学习\Core\Mini.Core\Mini.Model.Entity", "Mini.Model.Entity", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_IRepository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Mini.CoreApi.IRepository", "Mini.CoreApi.IRepository", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_IServices_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Mini.CoreApi.IServices", "Mini.CoreApi.IServices", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Repository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Mini.CoreApi.Repository", "Mini.CoreApi.Repository", tableNames, "", isMuti);
            return true;
        }
        ...
        {
            Create_Services_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Mini.CoreApi.Services", "Mini.CoreApi.Services", tableNames, "", isMuti);
            return true;
        }
...
@"using Mini.CoreApi.IServices;
using Mini.CoreApi.Model;
using Mini.CoreApi.Model.Models;
     ...
     public class {ClassName}Controller : ControllerBase
    {
            ...
            )
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                 ...
                 .SettingClassTemplate(p => p =
@"using Mini.CoreApi.IRepository.Base;
using Mini.CoreApi.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
    ...
    public interface I{ClassName}Repository : IBaseRepository<{ClassName}>" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
    {
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"using Mini.CoreApi.IServices.BASE;
using Mini.CoreApi.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
    ...
    public interface I{ClassName}Services :IBaseServices<{ClassName}>" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
	{
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"using Mini.CoreApi.IRepository" + (isMuti ? "." + ConnId + "" : "") + @";
using Mini.CoreApi.IRepository.UnitOfWork;
using Mini.CoreApi.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
using Mini.CoreApi.Repository.Base;
    ...
    public class {ClassName}Repository : BaseRepository<{ClassName}>, I{ClassName}Repository" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
    {
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"
using Mini.CoreApi.IServices" + (isMuti ? "." + ConnId + "" : "") + @";
using Mini.CoreApi.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
using Mini.CoreApi.Services.BASE;
using Mini.CoreApi.IRepository.Base;
