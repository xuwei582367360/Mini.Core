...
namespace Mini.Extensions.Authorization
{
    public class JwtHelper
    {
        ...
        public static string IssueJwt(UserInfo userInfo)
        {
            ...
            string secret = Appsettings.app(new string[] { "JwtSetting", "SecretKey" });
            ...
            // 可以将一个用户的多个角色全部赋予；
            // 作者：DX 提供技术支持；
            claims.AddRange(userInfo.Role.Split(',').Select(s => new Claim(ClaimTypes.Role, s)));
